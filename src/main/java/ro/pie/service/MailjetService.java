...
public class MailjetService {
    ...
    public void sendEmail(String sendTo,String firstName, Long discount, String code) throws MailjetSocketTimeoutException, MailjetException {
                        ...
                        .put(new JSONObject()
                                ...
                                .put(Emailv31.Message.TO, new JSONArray()
                                        .put(new JSONObject()
                                                .put("Email", sendTo)
                                                .put("Name", firstName)))
                                .put(Emailv31.Message.TEMPLATEID, 2399862)
